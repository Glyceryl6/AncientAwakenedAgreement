package com.glyceryl6.aaa.data.level.feature;
...
public class AAATreeFeatures {
    ...
    private static TreeConfiguration.TreeConfigurationBuilder createIronBirch() {
        return TreeFeatures.createStraightBlobTree(AAABlocks.IRON_BIRCH_LOG.get(), AAABlocks.IRON_BIRCH_LEAVES.get(), 5, 2, 0, 2).ignoreVines();
    }

    private static TreeConfiguration.TreeConfigurationBuilder createBeech() {
        return TreeFeatures.createStraightBlobTree(AAABlocks.BEECH_LOG.get(), AAABlocks.BEECH_LEAVES.get(), 4, 2, 0, 2).ignoreVines();
    }

    private static TreeConfiguration.TreeConfigurationBuilder createSuperIronBirch() {
        return TreeFeatures.createStraightBlobTree(AAABlocks.IRON_BIRCH_LOG.get(), AAABlocks.IRON_BIRCH_LEAVES.get(), 5, 2, 6, 2).ignoreVines();
    }

    private static TreeConfiguration.TreeConfigurationBuilder createFancyBeech() {
        return (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(AAABlocks.BEECH_LOG.get()),
                new FancyTrunkPlacer(3, 11, 0), BlockStateProvider.simple(AAABlocks.BEECH_LEAVES.get()),
